                                    ...
                                    <form id="register" action="" method="post">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <fieldset>
                                                    <input name="first-name" type="text" id="first-name" placeholder="Your first name" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <fieldset>
                                                    <input name="last-name" type="text" id="last-name" placeholder="Your last name" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <fieldset>
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    <button type="submit" id="submit" class="main-button">Register</button>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </form>
